...
(function () {
  'use strict';
  if (window.__MAS_VER__ === '1.5.21') return;
  window.__MAS_VER__ = '1.5.21';
  ...
  function inspectActiveFeedCard() {
    const root = getActiveFeedRoot()
      || document.querySelector('[data-e2e="feed-active-video"], .swiper-slide-active');
    ...
    const nodes = root.querySelectorAll('span, a, p, div, label, i, button');

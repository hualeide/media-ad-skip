...
| Logo | **300×300** PNG → 仓库已备 [`store/logo-300x300.png`](store/logo-300x300.png) |
| 小宣传图 | **440×280** PNG → 仓库已备 [`store/promo-440x280.png`](store/promo-440x280.png) |
| 截图 | 至少 1 张，建议 **1280×800** 或 **1366×768**（需真机截，仓库不代截） |

...
[![Version](https://img.shields.io/badge/version-1.5.29-blue.svg)](./extension/manifest.json)
...
> **仅在 B站、抖音页面注入**；其它网站不会运行。当前 **1.5.29**。隐私说明见 [`extension/PRIVACY.md`](extension/PRIVACY.md)。
